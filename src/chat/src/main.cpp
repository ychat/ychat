...
int main(int argc, char *argv[])
{
	...
	// 设置配置参数表
	ms.set_cfg_int(ychat::var_conf_int_tab);
	ms.set_cfg_int64(ychat::var_conf_int64_tab);
	ms.set_cfg_str(ychat::var_conf_str_tab);
	ms.set_cfg_bool(ychat::var_conf_bool_tab);
